...
class MADDPG(object):
    ...
    def update(self, sample, agent_i, parallel=False, grad_norm=0.5):
        ...
        target_q = curr_agent.compute_q_val(trgt_vf_in, target=True) 
        ...
        pol_reg_loss = ((curr_pol_out.reshape(bs*ts, -1))**2).mean() * 1e-3
