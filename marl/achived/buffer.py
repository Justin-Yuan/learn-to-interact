...
class ReplayBuffer(object):
    ...
    def push(self, observations, actions, rewards, next_observations, dones):
        """ each pushed entity with shape (B,N,D), except actions is (N,B,D)
        B: batch size, N: num of agents, D: dim 
        """
    ...
    def sample(self, N, to_gpu=False, norm_rews=True):
        ...
        each {}_n is list of n (#agents) of arrays of shape (N,D)
        """
        ...
        if norm_rews:   # normalize rewardss
    ...
    def get_average_rewards(self, N):
        ...
        else:   # not enough experience in buffer yet 
